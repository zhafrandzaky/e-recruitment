...
| Status Lamaran | Application Status | One of: Pending (Menunggu), Shortlisted (Lolos Seleksi Berkas), Rejected (Ditolak). |
...
| Time-to-Hire | Time-to-Hire | The average number of days from a job posting's creation to an applicant reaching a final accepted status. |
